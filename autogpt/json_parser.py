...
def fix_json(json_str: str, schema: str) -> str:
    ...
    messages = [
        {
            "role": "system",
            "content": f"Please adjust the following json to be valid: \n {json_str}",
        },
    ]
    fixed_json_str = create_chat_completion(model=cfg.fast_llm_model, messages=messages, temperature=0)
    try:
